...
\begin{tikzpicture}[>=stealth',shorten >=1pt,auto,node distance=3cm,
  ...
  %begin{Игровые персонажи}
    ...
    \node[rectangle] (Margaret) at (-15,-5) {Маргарет \vampire \\ \tiny Вентру};
  ...
  %\begin{Неигровые персонажи}
    \node[ellipse] (Avessolom) [node distance = 8cm,below left  = of Daren] {Авессолом \vampire \\\tiny древний колдун, Цимисх?};
    ...
    \node[ellipse] (Charlie) [node distance=1cm,below = of Sophie] {Чарли \vampire \\ \tiny<<Берд>> \\Саливан \\ \tiny журналист};    
