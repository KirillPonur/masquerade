...
\begin{tikzpicture}[>=stealth',shorten >=1pt,auto,node distance=3cm,
  ...
  %begin{Игровые персонажи}
    ...
    \node[rectangle] (Joseph) at (-15,0) {Джозеф \vampire \\ \tiny Тореодор \\ \tiny музейный сторож};
    \node[rectangle] (Brut)  at (-20,-7) {Брут \vampire \\\tiny Гангрел \\ \tiny лесник};
    \node[rectangle] (June) at  (-15,-10) {Джун \vampire\\\tiny Бруха  \\ \tiny бармен, наркоторговец};
  ...
  %begin{Отношения Дарена}
    ...
    \draw\relationship{|\tiny| подозрительный новенький}[->] (Daren) to [left] (Adam);
